    ...
    return (
        <header className="fixed top-0 w-full z-50 bg-surface/90 backdrop-blur-xl shadow-[0_1px_8px_rgba(0,0,0,0.04)]">
            <div className="h-20 max-w-7xl mx-auto px-margin-mobile lg:px-margin-desktop flex items-center justify-between gap-space-md">
                ...
                {/* Navigation Tabs */}
                <nav className="flex flex-wrap items-center gap-space-2xs md:gap-space-xs bg-surface-container-low p-1 rounded-xl shadow-[0_1px_4px_rgba(22,74,65,0.04)] overflow-x-auto max-w-full relative top-12">
                    {tabs.map((tab) => {
                        ...
                        return (
                            <button
                                ...
                                className={`px-2 md:px-space-sm py-1.5 md:py-2 transition-colors rounded-lg whitespace-nowrap text-xs md:text-sm ${isActive
