              ...
              <div className="bg-surface-container-low rounded-xl p-space-md flex flex-col items-center justify-center relative shadow-sm">
                <div className="bg-surface-container-lowest p-space-md rounded-xl shadow-md flex flex-col items-center justify-center relative">
                  <div className="relative w-56 h-56 flex items-center justify-center">
                    ...
                    >
                      {/* QR Finder Patterns */}
                      <rect x="10" y="10" width="50" height="50" rx="6" fill="currentColor" />
                      <rect x="18" y="18" width="34" height="34" rx="3" fill="#ffffff" />
                      <rect x="26" y="26" width="18" height="18" rx="2" fill="currentColor" />

                      <rect x="140" y="10" width="50" height="50" rx="6" fill="currentColor" />
                      <rect x="148" y="18" width="34" height="34" rx="3" fill="#ffffff" />
                      <rect x="156" y="26" width="18" height="18" rx="2" fill="currentColor" />

                      <rect x="10" y="140" width="50" height="50" rx="6" fill="currentColor" />
                      <rect x="18" y="148" width="34" height="34" rx="3" fill="#ffffff" />
                      <rect x="26" y="156" width="18" height="18" rx="2" fill="currentColor" />

                      {/* Timing Patterns */}
                      <line x1="68" y1="35" x2="132" y2="35" stroke="currentColor" strokeWidth="8" strokeDasharray="8 8" />
                      <line x1="35" y1="68" x2="35" y2="132" stroke="currentColor" strokeWidth="8" strokeDasharray="8 8" />

                      {/* Random Data Modules */}
                      <rect x="70" y="10" width="12" height="12" rx="2" />
                      <rect x="90" y="10" width="12" height="12" rx="2" />
                      <rect x="110" y="10" width="12" height="12" rx="2" />
                      <rect x="10" y="70" width="12" height="12" rx="2" />
                      <rect x="10" y="90" width="12" height="12" rx="2" />
                      <rect x="10" y="110" width="12" height="12" rx="2" />
                      <rect x="140" y="70" width="12" height="12" rx="2" />
                      <rect x="160" y="70" width="12" height="12" rx="2" />
                      <rect x="180" y="70" width="12" height="12" rx="2" />
                      <rect x="70" y="55" width="12" height="12" rx="2" />
                      <rect x="120" y="55" width="12" height="12" rx="2" />
                      ...
                      <rect x="140" y="160" width="12" height="12" rx="2" />
                      <rect x="160" y="160" width="12" height="12" rx="2" />
                      <rect x="180" y="160" width="12" height="12" rx="2" />
                      <rect x="140" y="180" width="12" height="12" rx="2" />
                      <rect x="70" y="180" width="12" height="12" rx="2" />
                      <rect x="110" y="180" width="12" height="12" rx="2" />
                      <rect x="130" y="110" width="12" height="12" rx="2" />
                      <rect x="150" y="110" width="12" height="12" rx="2" />
                      <rect x="170" y="110" width="12" height="12" rx="2" />
                    </svg>

                    {/* Centered Crest */}
                    <div className="absolute w-12 h-12 bg-primary rounded-xl flex items-center justify-center text-on-primary shadow-lg border-2 border-surface-container-lowest">
                  ...
                  <span className="font-label-sm text-label-sm text-on-surface-variant mt-space-xs font-mono font-bold">
                    dhr.sahayak.rail/{scenarioId}
                  </span>
                </div>

                <div className="mt-space-md p-space-xs rounded-lg bg-surface-container-lowest/80 text-on-surface-variant text-[12px] flex items-center gap-space-xs">
                  <span className="material-symbols-outlined text-secondary text-[16px]">
                    check_circle
                  </span>
                  <span>
                    <strong>Payload Ready</strong>: Status: <em>{title}</em> • Action: <em>{action}</em>
                  </span>
                </div>
              </div>
